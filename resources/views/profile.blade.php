                ...
                <x-forms.fieldset label="Upload Photo" name="photo" bag="edit">
                    <div class="flex gap-2">
                        ...
                        @if(optional($data)->photo)
                            ...
                            <a href="{{ asset('storage/' . $data->photo) }}" target="_blank" class="btn btn-soft btn-sm btn-square btn-info">
                ...
                <x-forms.fieldset label="Upload CV" name="cv" bag="edit">
                    <div class="flex gap-2">
                        ...
                        @if(optional($data)->cv)
                            ...
                            <a href="{{ asset('storage/' . $data->cv) }}" target="_blank" class="btn btn-soft btn-sm btn-square btn-info">
                                <i class="fi fi-sr-file"></i>
                            </a>
                        @endif
                    </div>
                ...
                <x-forms.fieldset label="Upload KTP (Indonesian ID Card)" name="ktp" bag="edit">
                    <div class="flex gap-2">
                        ...
                        @if(optional($data)->ktp)
                            ...
                            <a href="{{ asset('storage/' . $data->ktp) }}" target="_blank" class="btn btn-soft btn-sm btn-square btn-info">
                                <i class="fi fi-sr-file"></i>
                            </a>
                        @endif
                    </div>
